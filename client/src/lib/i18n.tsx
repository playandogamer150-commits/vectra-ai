...
const translations = {
  "en": {
    ...
    hotStudio: {
      ...
      generate: "Generate",
      selectFiltersHint: "Select at least one filter to generate",
      gallery: "Generated Images",
      clear: "Clear",
      noImages: "No images generated yet",
      selectFiltersStart: "Select filters and click Generate",
    ...
    modelslab: {
      ...
      exportTitle: "PromptForge Export",
      exportPrompt: "Prompt",
      exportSeed: "Seed",
  ...
  "pt-BR": {
    ...
    hotStudio: {
      ...
      generating: "Gerando...",
      generate: "Gerar",
      selectFiltersHint: "Selecione pelo menos um filtro para gerar",
      gallery: "Imagens Geradas",
      clear: "Limpar",
      noImages: "Nenhuma imagem gerada ainda",
      selectFiltersStart: "Selecione filtros e clique em Gerar",
    ...
    modelslab: {
      ...
      exportTitle: "Exportação PromptForge",
      exportPrompt: "Prompt",
      exportSeed: "Seed",
