...
const translations = {
  "en": {
    ...
    modelslab: {
      ...
      transformToVideoFull: "Transform to Video with VEO 3.1",
      videoDialogTitle: "VEO 3.1 Hyper-Realistic Video",
      videoDialogDescription: "Generate a hyper-realistic video from your image",
      videoSpecs: "VEO 3.1 generates 8-second hyper-realistic videos at 720p/1080p with 24fps.",
      videoCostNote: "Images are automatically upscaled for optimal VEO 3.1 quality. Generation may take 2-4 minutes.",
      ...
      videoProcessing: "Generating video... This may take a few minutes.",
  ...
  "pt-BR": {
    ...
    modelslab: {
      ...
      transformToVideoFull: "Transformar em Vídeo com VEO 3.1",
      videoDialogTitle: "Vídeo Hiper-Realista VEO 3.1",
      videoDialogDescription: "Gere um vídeo hiper-realista a partir da sua imagem",
      videoSpecs: "VEO 3.1 gera vídeos hiper-realistas de 8 segundos em 720p/1080p com 24fps.",
      videoCostNote: "Imagens são automaticamente ampliadas para qualidade ideal. Geração pode levar 2-4 minutos.",
      ...
      videoProcessing: "Gerando vídeo... Isso pode levar alguns minutos.",
