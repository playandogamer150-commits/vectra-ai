...
const translations = {
  "en": {
    ...
    modelslab: {
      ...
      videoDialogDescription: "Generate a video from your image",
      videoSpecs: "Generates ~5 second videos at 18fps from your image.",
  ...
  "pt-BR": {
    ...
    modelslab: {
      ...
      videoDialogDescription: "Gere um vídeo a partir da sua imagem",
      videoSpecs: "Gera vídeos de ~5 segundos a 18fps a partir da sua imagem.",
      videoCostNote: "A geração do vídeo pode levar de 1 a 3 minutos para ser concluída.",
