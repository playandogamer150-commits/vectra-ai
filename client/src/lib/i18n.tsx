...
const translations = {
  "en": {
    ...
    modelslab: {
      ...
      videoDialogTitle: "Transform to Video",
      videoDialogDescription: "Generate a video from your image using VEO 3.1",
      videoSpecs: "VEO 3.1 Fast generates 8-second videos at 720p/1080p with 24fps.",
      videoUpscaleNote: "Images are automatically upscaled for optimal video quality.",
  ...
  "pt-BR": {
    ...
    modelslab: {
      ...
      videoDialogTitle: "Transformar em Vídeo",
      videoDialogDescription: "Gere um vídeo a partir da sua imagem usando VEO 3.1",
      videoSpecs: "VEO 3.1 Fast gera vídeos de 8 segundos em 720p/1080p com 24fps.",
      videoUpscaleNote: "Imagens são automaticamente ampliadas para qualidade de vídeo ideal.",
